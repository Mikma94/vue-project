...
},{"./bundle-url":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/vue-select/src/scss/vue-select.scss":[function(require,module,exports) {
...
},{}],"components/BitCoinsComponent.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    _axios.default.get('https://api.coindesk.com/v1/bpi/currentprice.json').then(function (response) {
      return _this.apiResponse = response.data;
    });
  },
  methods: {
    onCoinSelected: function onCoinSelected(value) {
...
exports.default = _default;
        var $2339c5 = exports.default || module.exports;
      
      if (typeof $2339c5 === 'function') {
        $2339c5 = $2339c5.options;
      }
    
        /* template */
        Object.assign($2339c5, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "div",
    [
      _c("h1", [_vm._v("Equivalencias en BitCoins")]),
      _vm._v(" "),
      _c("label", [_vm._v("Ultima actualización:")]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.apiResponse.time.updated,
            expression: "apiResponse.time.updated"
          }
        ],
        staticClass: "form-label",
        domProps: { value: _vm.apiResponse.time.updated },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.apiResponse.time, "updated", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
      _c("br"),
      _vm._v(" "),
      _c("label", [_vm._v("Selecciona tipo de moneda")]),
      _vm._v(" "),
      _c("v-select", {
        attrs: { options: _vm.options },
        on: { input: _vm.onCoinSelected }
      }),
      _vm._v(" "),
      _c("br"),
      _vm._v(" "),
      _vm.bitCoinValue ? _c("label", [_vm._v("Valor en BitCoins")]) : _vm._e(),
      _vm._v(" "),
      _vm.bitCoinValue
        ? _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.bitCoinValue,
                expression: "bitCoinValue"
              }
            ],
            staticClass: "form-label",
            domProps: { value: _vm.bitCoinValue },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.bitCoinValue = $event.target.value
              }
            }
          })
        : _vm._e(),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2339c5', $2339c5);
          } else {
            api.reload('$2339c5', $2339c5);
          }
        }
...
var _BitCoinsComponent = _interopRequireDefault(require("/components/BitCoinsComponent"));
...
//
var _default = {
  name: 'BitCoinsEquivalences',
  components: {
    'mf-bit-coins-component': _BitCoinsComponent.default
  },
  data: function data() {
    return {
      dummy: []
...
exports.default = _default;
        var $f1fe22 = exports.default || module.exports;
      
      if (typeof $f1fe22 === 'function') {
        $f1fe22 = $f1fe22.options;
      }
    
        /* template */
        Object.assign($f1fe22, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "app" } }, [_c("mf-bit-coins-component")], 1)
}
var staticRenderFns = []
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f1fe22', $f1fe22);
          } else {
            api.reload('$f1fe22', $f1fe22);
          }
        }
...
},{"/components/BitCoinsComponent":"components/BitCoinsComponent.vue","vue-select/dist/vue-select.css":"../node_modules/vue-select/dist/vue-select.css","_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
